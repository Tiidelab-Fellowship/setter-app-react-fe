...
import {
  ...
  LoginFooter,
  BigInput,
} from "../Components/Forms/Forms-body";
...
export const LoginBody = () => {
  ...
  const textarea =
    "You don't need to stress your self when trying to put yourself out there. We are here to help you optimize the use of your social media";
  ...
  return (
    // <div className="totalContainerWrapper">
